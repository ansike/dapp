 ...
 * @LastEditTime: 2023-02-23 00:16:23
 */
...
module.exports = async function (callback) {
  ...
  // 1. 创建订单
  // 100 ASK <=> 1 ETH
  await exchange.makeOrder(askToken.address, toWei(100), ETH_ADDRESS, toWei(1));
  await exchange.makeOrder(askToken.address, toWei(102), ETH_ADDRESS, toWei(2));
